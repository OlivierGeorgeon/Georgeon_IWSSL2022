...
\begin{figure}[htbp]
	...
	{\caption{The software architecture implemented on a remote PC. 
			...
			Bottom-right: Allocentric memory shows the position of the echos (orange cells), the explored cells (white), the position of the robot (green), the unexplored cells (grey).}}
...
The allocentric memory stores a spatial representation in a coordinate system relative to the environment. 
It is inspired by \textit{grid cells} in the hippocampus of the mammalian brain \citep{grieves_representation_2017}, and reproduces their hexagonal structure (\figureref{fig:architecture}, bottom right). 
