...
We called this process Synthesizer because it synthesizes a set of experiences into a single data structure that represents the object that affords these experiences. 
...
Once the robot has circled around an abject, the object becomes identified as a single entity, then the synthesizer copies its representation from allocentric memory to the phenomenon data structure.
...
More broadly, such models can improve our understanding on how animals construct knowledge of objects through experience of interaction. 
