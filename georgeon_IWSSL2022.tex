...
Our phenomenon data structure contains a set of affordances (\figureref{fig:phenomenon}) and a decimal \textit{confidence coefficient} in the range $[0, 1]$. 
...
\begin{figure}[htbp]
	...
	The object was made of two moneyboxes similar to the one in \figureref{fig:architecture} next to each other.
