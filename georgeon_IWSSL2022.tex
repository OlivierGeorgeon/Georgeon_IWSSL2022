...
Instead, it aims at organizing behavior spatially in the vicinity of objects to design robots that mimic intrinsic motivation \citep[e.g.,][]{gottlieb_towards_2018} such as playfulness and curiosity as they discover and interact with unknown objects. 
...
\begin{figure}[htbp]
	...
	{\caption{The experimental setup. 
		    ...
		    The omni-directional wheels allow the robot to translate laterally.}}
...
The cognitive architecture stores a list of behaviors that define patterns of behaviors as \textit{sequences of experiences} that the robot can enact. 
After each interaction cycle, the decider searches this list and activates the behaviors whose beginning sub-sequence matches experiences present in egocentric memory. 
...
We have presented this mechanism in previous studies \citep{georgeon_eca_2013}, where we explained how the list of behaviors could be learned by a bottom-up sequential learning mechanism driven by intrinsic motivation. 
...
The robot wanders randomly until it detects an object nearby, and then it circles around this object until it is removed by the experimenter. 
